...
import BranchStats2 from './BranchStats2.js';
  ...
  const tabs = [
      ...
      component: () => (
        <>
          <div className="bg-gray-50 border-slate-300 border mt-3 px-4 py-2 text-sm rounded-md">
            A branch is considered to be healthy if <strong>all</strong> of the following
            conditions are met.
            <ul className="list-disc px-4">
              <li>It has a commit in the last 15 days.</li>
              <li>
                It is ahead of the <code>{defaultBranch}</code> branch by no more than 10
                commits.
              </li>
              <li>
                It is behind the <code>{defaultBranch}</code> branch by no more than 10
                commits.
              </li>
            </ul>
            <div className="mt-1">
              The <code>{defaultBranch}</code> branch is always considered to be healthy.
            </div>
          </div>
    ...
    },
    {
      ...
      component: () => (
        <>
          <div className="bg-gray-50 border-slate-300 border mt-3 px-4 py-2 text-sm rounded-md">
            A branch is considered to be a delete candidate if <strong>all</strong> of the
        ...
        <>
          <div className="bg-gray-50 border-slate-300 border mt-3 px-4 py-2 text-sm rounded-md">
            ...
            <ul className="list-disc px-4">
              <li>It is not already marked as a healthy branch.</li>
              <li>
                It is ahead of the <code>{defaultBranch}</code> by at least one commit.
              </li>
    ...
    },
    {
      ...
      component: () => (
        <>
          <div className="bg-gray-50 border-slate-300 border mt-3 px-4 py-2 text-sm rounded-md">
            If a branch isn't marked as 'healthy', a 'delete candidate', or 'abandoned',
            it's considered to be unhealthy. These branches are out of sync with{' '}
            <code>{defaultBranch}</code> and have't seen any commits in a while.
          </div>
...
export default (
  ...
  return {
    ...
    Component: () => {
      const [showNewBranches] = useQueryParam('branches-v2', asBoolean);
      return (
        <>
          {showNewBranches ? (
            <>
          ...
          <Branches branchStats={branches} defaultBranch={defaultBranch} />
        </>
      );
    },
  };
