...
const BuildsOld: React.FC<{builds: RepoAnalysis['builds']; queryPeriodDays: number}> = ({ builds, queryPeriodDays }) => {
...
const BuildsNew: React.FC<{builds: RepoAnalysis['builds']; queryPeriodDays: number}> = ({ builds, queryPeriodDays }) => {
  const [expandedRows, setExpandedRows] = useState<string[]>([]);
