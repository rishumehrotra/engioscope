...
const YAMLPipelinesDrawer = lazy(() => import('../repo-summary/YAMLPipelinesDrawer.jsx'));
const SonarReposDrawer = lazy(() => import('../repo-summary/SonarReposDrawer.jsx'));
const TestsDrawer = lazy(() => import('../repo-summary/TestsDrawer.jsx'));
const BuildPipelinesDrawer = lazy(
  () => import('../repo-summary/BuildPipelinesDrawer.jsx')
);
