...
type RevisionsProps = Pick<
  GanttRowProps,
  'revisions' | 'rowIndex' | 'timeToXCoord' | 'colorForStage'
...
export const Revisions: React.FC<RevisionsProps> = ({
  ...
  revisions === 'loading' ? (
    <foreignObject
      ...
      className="pointer-events-none"
    >
      <div className="text-xs pl-1 w-full text-gray-500">Loading...</div>
    </foreignObject>
  ) : (
    <>
            ...
            {isWorkItemRow(row) ? (
              ...
              >
                ...
                <div className="text-sm text-gray-800 flex items-center">
                  ...
                  {isWorkItemTypeRow(row) ||
                  isWorkItemEnvironmentRow(row) ||
                  isProjectRow(row)
