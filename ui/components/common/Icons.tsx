...
export const Ascending = ({ tooltip }: {tooltip: string}) => (
  <svg data-tip={tooltip} xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const Filters: React.FC<{ className?: string; tooltip?: string }> = ({ className, tooltip }) => (
  <svg data-tip={tooltip} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className={`h-6 w-7 ${className || ''}`}>
